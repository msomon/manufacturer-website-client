...
const Navbar = () => {
    ...
    const menuItems = <>
        ...
        <li><Link to="/businesssummary">Bussiness Summary</Link></li>
        {
            user && <li><Link to="/myprofile">My Profile</Link></li>
        }
    
        <li>{user ? <button className="btn btn-ghost small" onClick={logout} >Sign Out</button> : <Link to="/login">Login</Link>}</li>
    </>
    return (
